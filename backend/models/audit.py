...
_ACTION_CATEGORIES = [
    ...
    ("PRINT_RECEIPT",    "Receipt", "info",      "bi-file-earmark-pdf-fill"),
    ("VIEW_RECEIPT",     "Receipt", "secondary", "bi-receipt"),
    ("BACKUP_RESTORE",   "Backup",  "danger",    "bi-arrow-counterclockwise"),
    ("BACKUP_DELETE",    "Backup",  "danger",    "bi-trash-fill"),
    ("BACKUP_DOWNLOAD",  "Backup",  "info",      "bi-download"),
    ("BACKUP_CREATE",    "Backup",  "success",   "bi-database-fill-add"),
